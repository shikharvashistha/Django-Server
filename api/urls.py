...
urlpatterns = [
    ...
    path('user/<int:userID>/wallet/', UserSIPWallet.as_view(), name='usersipwallet'),
    ...
    path('user/<int:userID>/sip/<int:sipID>/edit/', UserSIPEdit.as_view(), name='usersipassets'),
    ...
    path('api/status/', Status.as_view(), name='status'),
]